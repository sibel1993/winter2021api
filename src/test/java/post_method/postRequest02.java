...
public class postRequest02 extends JsonPlaceHolderBaseUrl {
    ...
    public void post01(){
        ...
        //2.way: Jsonpath with soft assertion(verification)==>1)create softAssert object  b)use assert methods c)assertAll()
